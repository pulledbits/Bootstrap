...
function __open(string $resourcePath)
{
    ...
    {
        __open('D:\\Rik Meijer\\git\\rikmeijer\\Bootstrap\\src/resource\\generate.php')(...func_get_args());
    }
    ...
    function open(string $resourcePath, bool $cache): mixed
{
    ...
    {
        return __open('D:\\Rik Meijer\\git\\rikmeijer\\Bootstrap\\src/resource\\opener.php')(...func_get_args());
    }
